# ZorkBot
Codebase for the node.js based  [Microsoft Bot Framework][1]. application that I  built to play Zork, The Hitchiker's Guide To The Galaxy,
and a series of other InfoCom classic Interactive Fiction titles.
